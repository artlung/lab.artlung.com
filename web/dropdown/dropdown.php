...
<p class="date-attribution">From 2000 to about 2004</p>
    <h1 class="p-name">Dropdown / Select Box Navigation with JavaScript</h1>
...
&lt;/form&gt;
    ...
    <form action="../">
        <p><b>Choose a destination:</b><br>
            ...
            <input type="BUTTON"
                   value="Go there!"
                   onclick="ob=this.form.userChoice;for(i=0;i<ob.length;i++){if(ob[i].checked){window.open(ob[i].value,'_top');}}">
        </p>
    </form>
    <pre>
&lt;form action="../"&gt;
...
&lt;/form&gt;
    ...
    <blockquote>
        <b>Hayden Porter</b> changed the method I used for the email version from window.open to location.href to
        improve the action of the script
    </blockquote>
...
&lt;!-- coding tested and improved by Hayden Porter (hporter(at)uakron.edu)            --&gt;
    ...
    <p><strong>There is no end to the variations in dropdown navigation. I think - no - we've exhausted all the
            possibilities - whoops - here's another!</strong> - <em>We're trying to implement a pop-up window from a
            pull-down menu. We've
...
&lt;/form&gt;
    ...
    <p>To which I reply - sure thing - no problem! :-) Keep in mind IFRAMES have zero support in Netscape 4 or earlier.
        Mozilla, Netscape 6+ and IE support them though.
        See <a href="http://www.w3.org/TR/REC-html40/present/frames.html#h-16.5">http://www.w3.org/TR/REC-html40/present/frames.html#h-16.5</a>
        for more on IFRAME.</p>
    ...
    <iframe src="https://joecrawford.com/" name="myIFrame" width="400" height="200">You can't see this because your
...
&lt;/iframe&gt;
    ...
    <p><b>Answer:</b><br>
        Sure, here it is! <a href="/lab/scripting/dropdown-only-some-new-window/">Dropdown Navigation Where Only Some
            Links Open New Windows</a></p>
    ...
    <blockquote>
        <b>Question:</b>
        What's the code if I just want a select list, and then a submit button (which opens the selected link in the
        current window)?
    </blockquote>
...
&lt;/form&gt;
    ...
    <blockquote>
        <b>Question: </b>I used the portion of code you posted last. But instead of input type="button", I have
        type="image" src="images/gobutton.png". And when I make my selection and hit the button, it sends me to my root
        directory instead of the specified destination. However, when I use type="button", it works fine. Any advice?
    </blockquote>
    ...
    <form action="/" name="goForm">
        ...
        <a href="#Go"
           onclick="document.location.href=document.goForm.mySelectbox.options[document.goForm.mySelectbox.selectedIndex].value;"><img
                    src="https://artlung.com/images/go.gif" value="Go" border="0"/></a>
    </form>
