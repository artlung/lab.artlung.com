...
$lab->printHeader('outline: none CSS property');
?>


    <p class="date-attribution">Created January 2001; Updated July 2001</p>

    <h1>outline: none CSS property</h1>

    <h2><a
                href="https://artlung.com/">ArtLung.com</a> rocks!</h2>
    ...
    <p>The email link above has a style set to "outline: none" - the
        ...
        On IE5/WinNT this property does not do anything. <i><a href="/scripting/the-problem-with-blur/">This is a
                separate issue</a></i>. Francis U. sent me a note that Mozilla 0.92 does not respect the outline:none
        property, sadly. If you have additional feedback about this property in your browser of choice just <a
                href="https://artlung.com/feedback/">let me know</a>.
    </p>
