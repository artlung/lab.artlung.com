...
<span style="color:#FF0000;">tidy
  ...
  -quiet <span style="color:#666666">or</span> -q        <span
            style="color:#000000">suppress non-essential output</span>
  ...
  -help               <span style="color:#000000">list command line options</span>
    ...
    <pre>
<span style="color:#666666">C:\WINDOWS\Desktop&gt;<span style="color:#FF0000">tidy -i -m -wrap 400 -upper -f <span
                style="color:#3333FF">errors.txt</span> <span style="color:#3333FF">foo.html</span></span></span>
                   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
<span style="color:#666666">C:\WINDOWS\Desktop&gt;</span>    The DOS Prompt - in this case this is the desktop.
  ...
  <span style="color:#3333FF">foo.html</span>             The file tidy will work on and modify.
    ...
    <h2>Parting Words</h2>
    <p>
        HTML Tidy is *very* cool, and very powerful. I advise caution in using this files, there are no built in "undo"
        features in Tidy - but it's a nice tool if you're faced with grotesque pages.
    </p>
