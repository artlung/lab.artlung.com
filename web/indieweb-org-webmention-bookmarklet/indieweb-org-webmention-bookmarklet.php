...
?>
    ...
    <p class="date-attribution">Created Sep 2025, Updated March 2026</p>

    <h1 class="p-name">Show Webmentions pointed at <a href="https://indieweb.org/">IndieWeb.org</a> pages</h1>
    ...
    <p>
        It also injects a form to facilitate sending a webmention to the current page.
    </p>

    <div>
        <p>
            <?php
            $js = file_get_contents(__DIR__ . '/indieweb-org-webmention-bookmarklet.js');
    ...
    echo '?'.filemtime(__DIR__ . '/indieweb-org-webmention-bookmarklet.css');
    ?>">
<?php
$lab->printFooter(
    [
