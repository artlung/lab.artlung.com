...
?>
    ...
    <p>
        ...
        left side is <a href="http://www.microsoft.com/mac/products/ie/">Internet Explorer 5 for Macintosh</a>, the
        right is <a href="http://www.icab.de/">iCab</a>. I think it's a very good example of graceful degradation. To
        get "live" display of how different a page can look with or without CSS, you should drag CSS bookmarklets on my
        <a href="/scripting/bookmarklets/">cool bookmarklets</a> page. Have fun!
    </p>
