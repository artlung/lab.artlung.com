...
<p align="right"><i>Created: December/2001</i></p>

<h1>How to Encode URLs<br>
An ASCII to URLEncoded JavaScript</h1>

<p>You know how there can't be a space in a url? Well, if you encode it, it's not a space anymore. It turns into %20 - so that the URL works across the internet, where URLs don't get to have spaces in them. There are many other exotic characters as well - and they need to be encoded. In JavaScript you use the <a href="http://home.netscape.com/eng/mozilla/3.0/handbook/javascript/ref_d-e.htm#48073">escape()</a> function which is as old as JavaScript itself. More recently this has been deprecated in favor of <a href="http://developer.netscape.com/docs/manuals/js/core/jsref15/toplev.html#1118346">encodeURI()</a>. On the server side, in Cold Fusion you use <a href="http://www.opensesame.com/documents/cf4/cfml_language_reference/3_ColdFusion_Functions/lr3_210.htm">URLEncodedFormat()</a>, in php you use <a href="http://www.php.net/manual/en/function.rawurlencode.php">rawurlencode()</a> and in ASP you use <a href="http://msdn.microsoft.com/library/en-us/iisref/html/psdk/asp/vbob0wkl.asp">Server.URLEncode()</a>.</p>

<p>For a nice bookmark of the ASCII table, bookmark <a href="http://www.asciitable.com/">http://www.asciitable.com/</a></p>
