...
<p align="right">Created September 4, 2001</p>
...
<p>Now, everytime Apache sees php3, it will make believe that it's really php. This will also propagate to child directories.</p>

<p>It's a very simple solution, though I'm not sure it's the best solution performance-wise. Also, playing with mod_rewrite is always a bit scary, make sure you leave yourself an undo and test it. You can easily make things which break spectacularly.</p>
