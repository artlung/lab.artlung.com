...
<p align="right">Created April 14  2001</p>
...
<p>See it in action at <a href="http://artlung.com/images/">http://artlung.com/images/</a></p>
...
<p><a href="http://artlung.com/feedback/">What do you think?</a></p>
...
if (!isset($i)) { <span class="comment">// this first bit determines if the page got passed $i</span>
   ...
   $size = GetImageSize($i); <span class="comment">// grabs the height and width tags, providing an html</span>
                             ...
                             <span class="comment">// <a href="http://www.php.net/manual/en/function.getimagesize.php">http://www.php.net/manual/en/function.getimagesize.php</a></span>
?&gt;</span>
...
&lt;!-- this by Joe Crawford, April 2001 <a href="http://www.artlung.com/">http://www.artlung.com/</a> --&gt;
&lt;/body&gt;
&lt;/html&gt;
