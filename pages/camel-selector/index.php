...
pre b { color: #000; background-color: #CFC;}
...
<a href="http://timmorgan.info/jude/logarchives/000295.html">Tim Morgan's camelCase &lt;-&gt; selector-case</a> functions. Screaming Jedi cool.
But they use JavaScript regular expressions. JavaScript regular expressions I've never gotten cozy with. 
Perhaps I should seek counseling. Love the Regular Expressions in <a href="http://www.php.net">PHP</a> and <a href="http://www.macromedia.com/software/coldfusion/">Cold Fusion</a> though.
</p>
<p>
Anyway, here are some alternative functions, and a demonstration too. <i><a href="http://www.wikipedia.com/wiki/CamelCase">More on camelCase.</a></i>
</p>
<p>
<em>Useless.</em></p>
<p>
...
<input type="text" name="sample_selector" value="hello-world-foo-bar" size="30"><input type="button" value="noRegexToCamel()" onclick="this.form.selectorResult.value=noRegexToCamel(this.form.sample_selector.value)"><input type="text" name="selectorResult" size="30"></p>
...
<input type="text" name="sample_camel" value="barFooHelloWorld" size="30"><input type="button" value="noRegexToSel()" onclick="this.form.camelResult.value=noRegexToSel(this.form.sample_camel.value)"><input type="text" name="camelResult" size="30"></p>
