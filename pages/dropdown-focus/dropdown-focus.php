...
?>
    ...
    <p> <strong>ANSWER:</strong> focus is the right idea - but for a select box there's an easier way - the <code>selectedIndex</code> property of a <code>&lt;SELECT&gt;</code> element.
        Use that instead.</p>

    <p>The links below have <code>onMouseover</code> events which call a function <code>selSELECT()</code> and pass the numbers to select which option we want selected.</p>
...
<?php ob_start(); ?>
    <form action="./" name="myForm">
        <div>
            <a href="javascript:window.open(document.myForm.mySelectBox.options[document.myForm.mySelectBox.selectedIndex].value,'_top')" onmouseover="selSELECT(0)">0</a>
            <a href="javascript:window.open(document.myForm.mySelectBox.options[document.myForm.mySelectBox.selectedIndex].value,'_top')" onmouseover="selSELECT(1)">1</a>
            <a href="javascript:window.open(document.myForm.mySelectBox.options[document.myForm.mySelectBox.selectedIndex].value,'_top')" onmouseover="selSELECT(2)">2</a>
            <a href="javascript:window.open(document.myForm.mySelectBox.options[document.myForm.mySelectBox.selectedIndex].value,'_top')" onmouseover="selSELECT(3)">3</a>
            <a href="javascript:window.open(document.myForm.mySelectBox.options[document.myForm.mySelectBox.selectedIndex].value,'_top')" onmouseover="selSELECT(4)">4</a>
            <a href="javascript:window.open(document.myForm.mySelectBox.options[document.myForm.mySelectBox.selectedIndex].value,'_top')" onmouseover="selSELECT(5)">5</a>
            <a href="javascript:window.open(document.myForm.mySelectBox.options[document.myForm.mySelectBox.selectedIndex].value,'_top')" onmouseover="selSELECT(6)">6</a>
            <a href="javascript:window.open(document.myForm.mySelectBox.options[document.myForm.mySelectBox.selectedIndex].value,'_top')" onmouseover="selSELECT(7)">7</a>
        </div>
...
<pre><code><?= htmlentities($html) ?></code></pre>
