...
<h1>Robots-Nocontent (2008)</h1>
    ...
    <p>According to <a href="https://web.archive.org/web/20081102201233/http://help.yahoo.com/l/us/yahoo/search/webcrawler/slurp-14.html">this 2008 Yahoo! Page</a>, it was at one time possible to hide content inside a page from spidering by Yahoo.</p>

<blockquote>


<div class="yui-b">
    <!--Begin question--><div id="hlpQ"><h2><question>How do I mark web page content that is extraneous to the main unique content on the page?</question></h2></div>
    <!--End question--><div></div>
    <!--Begin answer--><div id="hlpA" class="article"><answer>Web pages often include headers, footers, navigational sections, repeated boilerplate text, copyright notices, ad sections, or dynamic content that is useful to users — but not to search engines. Webmasters can apply the "robots-nocontent" attribute to indicate to search engines any content that is extraneous to the main unique content of the page. Yahoo! Search observes the class="robots-nocontent" present on XHTML elements, such as div, span, and all others.
            <p> </p>
            ...
            <ul class="bb-list">
                <li>
                    <code class="bb-code">&lt;div class="robots-nocontent"&gt;</code> This is the navigational menu of the site and is common on all pages. It contains many terms and keywords not related to this site <code class="bb-code">&lt;/div&gt;</code>
                </li>
                <li>
                    <code class="bb-code">&lt;span class="robots-nocontent"&gt;</code> This is the site header that is present on all pages of the site and is not related to any particular page <code class="bb-code">&lt;/span&gt;</code>
                </li>
                <li>
                    <code class="bb-code">&lt;p class="robots-nocontent"&gt;</code>This is a boilerplate legal disclaimer required on each page of the site <code class="bb-code">&lt;/p&gt;</code>
                </li>
                <li>
                    <code class="bb-code">&lt;div class="robots-nocontent"&gt;</code> This is a section where ads are displayed on the page. Words that show up in ads may be entirely unrelated to the page contents <code class="bb-code">&lt;/div&gt;</code>
                </li>
            </ul>

            <p> </p>
            This attribute offers webmasters a great deal of flexibility.You can use the "class=robots-nocontent" attribute with all XHTML tags.</answer></div>
    <!--End answer-->
