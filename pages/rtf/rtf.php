...
Enter your zip:      <input type="text" name="zip" size="20">
        ...
        <input type="submit" value="Make a RTF Document with this data.">
    </form>
    <p align="right">
        <b>NOTE:</b> I didn't do an magic here, I just modified the ideas at <a href="http://www.irt.org/">irt.org</a>
        on <a href="http://tech.irt.org/articles/js154/">producing RTF files with Cold Fusion</a>
        <br>
    ...
    <p>
        <i><b>Update 1/2002:</b> Matthew Walden had some issues getting this to work under <acronym
                    title="Microsoft Internet Information Server">IIS</acronym> and Apache. His comments may be helpful.
            Thanks Matthew!</i>
    </p>
    <blockquote style="background-color: #CCC;">
        ...
        set for .php files. (For me this was C:\PHP\php.exe "%s" "%s"). Type .rtf as the extension and press OK.
        <br>
        <br>
