...
<p><em>Syntax of that map file come from <a href="https://httpd.apache.org/docs/2.4/mod/mod_imagemap.html">Apache</a></em>. Originally this image was on <a href="https://web.archive.org/web/19971024124040/https://arco.com/">here</a>.</p>
...
And then apache does the lookup and turns that x,y coordinate pair into <pre>https://lab.artlung.com/server-side-image-map/?n=News</pre>

From <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-ismap">MDN</a>:
<blockquote>
This Boolean attribute indicates that the image is part of a server-side map. If so, the coordinates where the user clicked on the image are sent to the server.<br /><br />
