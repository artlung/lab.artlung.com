...
<?php ob_start(); ?>
    ...
    <p>
        Useful for debugging RESTful interfaces. <em>Originally built when working on upgrade and account management flows with complicated parameter variations.</em>
        Originally written for Knockout 3.3.0. No changes were required to update to Knockout 3.5.1. URL data is stored locally in your browser. No data is sent or retained by the server.
    </p>
...
<?php print $html; ?>
    ...
    ?>"></script>
    <p class="about">
        A client-side <a href="https://knockoutjs.com">KnockoutJS</a> application which can compare two urls, including their url parameters.
